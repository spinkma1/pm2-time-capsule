...
const CapsuleDetail = ({  }) => {
    ...
    if (isLoading) {
        return <div className="flex justify-center items-center min-h-screen">Loading capsule details...</div>;
    }

    if (!capsule) {
        return <div className="flex justify-center items-center min-h-screen">Failed to load capsule details.</div>;
    }
    ...
    const handleLockCapsule = async () => {
        try {
            const response = await api.lockCapsule(id); // Call the API to lock the capsule
            if (response) {
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                        <div>
                        <h1 className="text-2xl font-bold text-gray-900 mb-2">{capsule.name}</h1>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-x-0 sm:space-x-4 text-sm text-gray-600">
                                ...
                                <div className="flex items-center mb-2 sm:mb-0">
                                    ...
                                    {capsule.users.length} přispěvatelů
