...
//
//    private CapsuleDto capsuleDto;
//
//    CapsuleServiceTest() {
//        CapsuleDto capsuleDto = new CapsuleDto(
//                1L, // id
//                new UserDto(1L, "User One", "User One", "Nothing", "Owner", List.of(), List.of()), // owner (UserDto)
//                "Test Capsule", // name
//                "This is a test capsule description", // description
//                true, // teamWork
//                1024L, // capsuleSize
//                LocalDateTime.now().plusDays(30).toString(), // unlockTime (converted to string)
//                "testPassword123", // qrCodePassword
//                50.0755, // unlockLat
//                14.4378, // unlockLongit
//                List.of( // users (List<UserDto>)
...
//                ),
//                new UnlockMethodsDto(true, false, false, false, false, false, false, false), // unlockMethods
//                "WAIT", // state
//                List.of() // content (empty list for now)
//        );
//    }
//
//    @BeforeEach
